<nav class="navbar navbar-default" style="margin-top: 10px;">
  <div class="container-fluid">
    ...
    <a class="navbar-brand visible-xs" href="#"><img src="${pageContext.servletContext.contextPath }/images/merchant-logo.png" style="position: relative;top: -5px;width: 130px;" alt="Indulge"/></a>
    <a class="brand hidden-xs" href="#"><img src="${pageContext.servletContext.contextPath }/images/merchant-logo.png" alt="Indulge"/></a>
    </div>
