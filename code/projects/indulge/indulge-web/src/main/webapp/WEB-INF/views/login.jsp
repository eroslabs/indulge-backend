  ...
  <div class="container">
    ...
    <div class = "row row15" style="border:1px solid #aea190; margin-top:30px;">
      <div class="col-md-15" style="padding:0px">
        <div style="background: url('${pageContext.servletContext.contextPath }/images/front.jpg') center center no-repeat;background-size:cover;height:480px;width:100%;border-bottom: solid 4px #1fbbad; padding-top:250px">
          <center>
        ...
        <div class="col-md-10 col-md-push-8 col-sm-10 col-sm-push-7 col-xs-12 col-xs-push-6"><a href="${pageContext.servletContext.contextPath}/register/input" class="btn-green btn btn-lg">SIGNUP AND GET LISTED FOR FREE</a></div>  
	</center>
        </div>
      </div>
    ...
    <div class="row row15" style="background: #1fbbad;margin-top:50px;">
      ...
      <span class="MerchantIcons col-md-24 col-sm-24" style="margin-bottom:50px;">
        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/face.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
	        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/Gym.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
	        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/Hair.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
	        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/haircut.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
	        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/Makeup.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
	        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/massage.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
	        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/Nail.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
        <div class="col-md-3 col-sm-6"><div style="background:url('${pageContext.servletContext.contextPath }/images/combo.png') center center no-repeat;background-size:100px 100px;height:120px;width:90%"></div> </div>
      </span>
    </div>
