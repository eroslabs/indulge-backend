...
<div class="container-fluid" id="header">
	...
	<center>
		<div class="col-xs-22 col-sm-14 col-md-12 col-lg-10 col-xs-push-1 col-sm-push-5 col-md-push-6 col-lg-push-7">
    		<div class="row font-type sign-up font-size-24 location-header">Forgot Password</div>
    		
    		<form:form method="GET" action="triggerForgot" modelAttribute="merchant" enctype="multipart/form-data" class="form-horizontal " style="margin-bottom:20px; margin-top:20px" >
    			<div class="form-group">
                <label class="sr-only">Email address / Registered Phone</label>
                <input type="text" autofocus="" required="" placeholder="Email or Phone no." class="form-control sign-in-username sign-in-place font-size-20" name='email' value='' >
              </div>
              <br/>
